...
var pathname_newpath = window.location.pathname.split( '/' );
var base_url_newpath=newpath+'/'+pathname_newpath[1]+'/';

var pathToImages = 'http://shuleonline.com/images/calendar/';	// Relative to your HTML file
