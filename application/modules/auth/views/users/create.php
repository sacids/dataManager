<div class="bg-gray-100">
    <div class="mx-auto py-2 px-4 sm:px-6 lg:px-8">
        <h1 class="text-xl font-medium tracking-tight text-gray-900">Register User</h1>
    </div>
...
<main class="bg-white h-[calc(100%-9rem)] flex overflow-hidden relative">
    <div class="flex-1 h-full overflow-y-scroll">
        <div class="mx-auto py-4 px-4 sm:px-6 lg:px-8">
            <?= form_open('auth/users/create', 'class="w-full md:w-2/3"'); ?>
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-1/4 px-3 mb-6 md:mb-0">
                    ...
                    <span class="text-red-500"><?= form_error('first_name'); ?></span>
                </div>
                ...
                <div class="w-full md:w-1/4 px-3 mb-6 md:mb-0">
                    ...
                    <span class="text-red-500"><?= form_error('last_name'); ?></span>
                </div>
                ...
                <div class="w-full md:w-1/4 px-3 mb-6 md:mb-0">
                    ...
                    <span class="text-red-500"><?= form_error('email'); ?></span>
                </div>
                ...
                <div class="w-full md:w-1/4 px-3 mb-6 md:mb-0">
                    ...
                    <span class="text-red-500"><?= form_error('phone'); ?></span>
                </div>
            </div>
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <span class="text-red-500"><?= form_error('identity'); ?></span>
                </div>
                ...
                <div class="w-full md:w-1/4 px-3 mb-6 md:mb-0">
                    ...
                    <span class="text-red-500"><?= form_error('password'); ?></span>
                </div>
                ...
                <div class="w-full md:w-1/4 px-3 mb-6 md:mb-0">
                    ...
                    <span class="text-red-500"><?= form_error('password_confirm'); ?></span>
                </div>
            </div>
                ...
                <div class="w-full px-3 mb-6 md:mb-0">
                    ...
                    <table class="text-sm font-normal">
                        <tr>
                            ...
                            <span class="text-red-500"><?= form_error('groups_ids[]'); ?></span>
                        </tr>
                    </table>
                </div>
            </div>
            ...
            <div class="flex items-start">
                <button type="submit" class="text-white bg-slate-800 hover:bg-red-900 focus:ring-4 font-medium rounded text-sm w-full sm:w-auto px-5 py-2.5 text-center">Register</button>
            </div>
