...
<div class="px-4 py-4">
    ...
    <!-- content -->
    <div class="flex flex-col flex-auto h-full mt-8 overflow-y-auto">
        <div class="flex flex-col flex-auto flex-shrink-0 h-full overflow-x-auto">
            ...
            <div class="w-full mt-3">
                <div id="error-messages" class="bg-red-100 rounded-b text-red-900 px-4 py-3 mb-4" style="display: none;"></div>
            </div>

            <div class="w-full mt-3">
                <div id="success-messages" class="bg-teal-100 rounded-b text-teal-900 px-4 py-3 mb-4" style="display: none;"></div>
            </div>

            <form id="myform" class="mb-12" role="form" enctype="multipart/form-data">
