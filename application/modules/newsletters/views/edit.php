                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                ?>
                                <?= form_dropdown("edition_id", $edition_options, set_value("edition_id", $story->edition_id), 'class="form-control"'); ?>
                            </div>
                        </div>
                    </div><!--./row -->
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?= form_dropdown("status", array("" => "Choose status", "draft" => "Draft", "published" => "Published"), set_value("status", $story->status), 'class="form-control"'); ?>
                            </div>
                        </div>
                    </div><!--./row -->
