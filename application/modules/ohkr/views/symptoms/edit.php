                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" placeholder="Enter title" class="form-control" value="<?php echo $symptom->title; ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="code" placeholder="Enter code" class="form-control" value="<?php echo $symptom->code; ?>">
                                </div>
