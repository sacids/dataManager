...
class Ohkr_model extends CI_Model
{
    ...
    public function get_diseases($limit = 30, $offset = 0)
    {
    ...
    public function get_disease_by_id($disease_id)
    {
        ...
        species, specie.id as s_id, specie.title as s_title')
            ->join(self::$table_name_species . " specie ", "disease.species = specie.id");
    ...
    public function find_by_disease_name($title)
    {
        $this->db->where("title", $title);
        return $this->db->get(self::$table_name_diseases)->row();
    }

    public function find_species_by_name($species_name)
    {
        $this->db->where("title", $species_name);
        return $this->db->get(self::$table_name_species)->row();
    }
}