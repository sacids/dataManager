 ...
 */
$config['site_title']                 = "AfyaData";       // Site Title, example.com
$config['admin_email']                = "afyadata@sacids.org"; // Admin Email, admin@example.com
$config['default_group']              = 'data_collectors';   // Default group, use name
