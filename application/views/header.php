        ...
        <div class="container-fluid">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                --><?php /*} */ ?>
                    ...
                    <?php if (perm_module('Campaign')) { ?>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Newsletters
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php display_full_name(); ?><span class="caret"></span></a>
                        <ul class="dropdown-menu">
