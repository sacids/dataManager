...
<div class="container">
    <div class="row">
        <?php echo form_open_multipart('blog/post/new_post', 'class="form-horizontal" role="form"'); ?>
        <div class="col-sm-12 col-md-10 col-lg-10 col-lg-offset-1 col-md-offset-1">
            ...
            <div class="col-sm-8">
                ...
                <div class="form-group">
                    <label for="campus"><?php echo $this->lang->line("label_content") ?> :</label>
                        <textarea class="form-control" name="content" placeholder="Enter post here"
                                  id="description"><?php echo set_value('content'); ?></textarea>
                    <script>
                ...
                <div class="form-group">
                    ...
                    <?php echo form_dropdown("status", array("draft" => "Draft", "published" => "Published"), set_value("access", ""), 'class="form-control"'); ?>
                </div>
