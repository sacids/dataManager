...
<head>
    ...
    <?php //echo base_url(); ?><!--assets/bootstrap/css/animate.min.css" type="text/css">-->
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                <li><a class="page-scroll" href="<?php echo base_url(); ?>#about">About AfyaData</a></li>
                <li><a class="page-scroll" href="<?php echo base_url(); ?>#features">Features</a></li>
                ...
                <li><a class="page-scroll" href="<?php echo base_url(); ?>#contact">Contact</a></li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
    </div>
